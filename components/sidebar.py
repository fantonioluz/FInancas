...
# ========= Layout ========= #
layout = dbc.Col([
                html.H1("Tecnowall", className="text-primary"),
                html.P("Finanças", className="text-info"),
                html.Hr(),
    ...
    #Seção Botoes --------------------
                                ...
                                dbc.AccordionItem(children=[
                                    dbc.Row([
                                        dbc.Col([ 
                                            ...
                                            html.Br(),
                                            dbc.Button("Adcionar", className="btn btn-success", id="add-category-receita", style={"margin-top": "20px"}),
                                            html.Br(),
                                            html.Div(id="category-div-add-receita", style={}),
                                        ], width=6),
                                        dbc.Col([ 
                                            html.Legend('Excluir categoris', style={'color': 'red'}),
                                            dbc.Checklist(
                ...
                #Modal Despasa
                dbc.Modal([
                    dbc.ModalHeader(dbc.ModalTitle('Adcionar Despesa')),
                    dbc.ModalBody([])
